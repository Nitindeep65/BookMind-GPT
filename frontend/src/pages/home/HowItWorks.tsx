...
export function HowItWorks() {
  return (
    <section id="how-it-works" className="py-16 sm:py-24 bg-gray-950 text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <p className="text-[11px] font-bold uppercase tracking-widest text-blue-400 mb-3">How it works</p>
        <h2 className="text-2xl sm:text-3xl font-bold tracking-tight mb-10 sm:mb-14">From upload to insight in seconds</h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 text-left">
          {STEPS.map((s) => (
            <div key={s.step} className="relative pl-4 sm:pl-5 border-l border-gray-700">
              <span className="block text-4xl sm:text-5xl font-black text-gray-800 mb-1 select-none">{s.step}</span>
